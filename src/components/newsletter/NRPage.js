...
export default function NRPage(props) {
    ...
    <table className='result-page newsletterR'>
      <thead>
        <tr>
          ...
          <th colSpan='' className={props.gen7}>
            2007
          </th>
      ...
      {result.map((res) => (
        <tbody>
          <tr key={res.id}>
            <td>
              <img src={`${protocol}://${props.site}/api/logos/${res.home_id}.png`} />
              {res.home_name}
            </td>
          ...
          <tr>
            <td>
              <img src={`${protocol}://${props.site}/api/logos/${res.away_id}.png`} />
              {res.away_name}
            </td>
